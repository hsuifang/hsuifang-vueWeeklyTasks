    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="d-flex justify-content-md-between">
          ...
          <Pagination :pageInfo="pageInfo" @changePage="changePage($emit)"></Pagination>
        </div>
      </div>
    </div>

    <ProductCanvasoff
      ref="productCanvasoff"
...
import ProductCanvasoff from '@/components/Canvasoff.vue';
  ...
  methods: {
    ...
    async submitProductItem({ isNew, content }) {
      try {
        ...
        if (success) {
          this.$refs.productCanvasoff.closeModal();
          if (productId) {
    ...
    handleProductItem(item) {
      ...
      this.$refs.productCanvasoff.openModal();
    },
